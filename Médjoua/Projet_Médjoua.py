...
def trouver_reponse(Question, choix1, choix2, choix3):
 ...
 # il revient à la question.
  ...
  return trouver_reponse(Question, choix1, choix2, choix3)
 


# La ligne 39 de code est la question principale dont chaque choix envoie une question liée à la question.
...
# Les questions en fonction du choix 1 de la question principale.
      ...
      reponse = trouver_reponse("Quels Metaux conduit du courant électrique correctement ?", "le fer", "L'étain", "le cuivre")
      if reponse == 3:
        print("bonne reponse")
      else:
        print("mauvaise reponse")
              
      reponse = trouver_reponse("le courant est il même dans un circuit serie ?", "oui", "non", "passe")
      if reponse == 1:
        print("bonne reponse")
      else:
        print("mauvaise reponse")
      ...
      reponse = trouver_reponse("Quel type de courant une pile prend ?", "CA", "CC", "aucun")
      if reponse == 2:
        print("bonne reponse")
      else:
        print("mauvaise reponse")
