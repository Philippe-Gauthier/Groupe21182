...
quiz("qui est le plus performent?", "Apple A19 Pro", "Dimensity 9500s", "Snapdragon 8 Elite Gen 5", "", "3")
...
quiz("quelle est la marque de RAM la plus vendu au monde?", "Corsair", "Kingston", "Crucial", "", "2")
quiz("quelle est la marque de SSD la plus vendu au monde?", "Samsung", "Western Digital", "Crucial", "", "1")
...
quiz(" quelle le plus petit CPU dans le monde?", "Intel N150", "Apple M4","AMD ryzen 7430U","Qualcomm Snapdragon 8 Gen 3", "1")