...
page_02 = "\n\nTu arrives en cuisine et tout semble normal, personne ne mentionne l'odeur d'alcool. Le chef arrive et te salue. «On est dans le rush déjà pour la préparation, va blanchir des patates.»"
page_03 = "\n\nUne fois arrivé, le chef te dévisage instantanémment. Il te reniffle. «T'es clairement ajeun...T'es pas un vrai cook!» Il te crie dessus et te force à quitter les lieux.\n\nGame Over\n"
page_04 = "\n\nIl te faut des chaudières, tu cherches un peu et entre dans une chambre froide où il y a plein plein plein de chaudières."
page_05 = "\n\nLe cuisinier te sourit. «Oublie les patates big, Marco s'en occupe. Aide moi à couper des légumes pour ce soir.»"
page_06 = "\n\nLe chef te voit se promener avec une cannette de peinture blanche, se fâche et te renvoi sur le champ.\n\nGame Over\n"
...
page_08 = "\n\nBien joué! Jusqu'à présent personne ne soupçonne ton manque extrême de connaissances culinaires. T'as réussi à blanchir une chaudière de patates."
...
page_10 = "\n\nL'angoisse s'empare de toi, tu te mets à suer à profusion. Tu regardes à nouveau le cuisinier, il a un tattoo de larme sous l'oeil, tu ne te sens pas très bien."
page_11 = "\n\nLa chance te sourit, il t'avoue lui aussi avoir menti sur son CV. «T'as juste à donner des ordres et les gens pensent que tu sais ce que tu fais.»"
page_12 = "\n\nLe chef passe près de toi et voit que tu ne fais rien. Il te demande avec un ton fâché d'aller chercher des culs de poule pour continuer la préparation."
page_13 = "\n\nTu viens de te tirer dans le pied. Une pause? En cuisine? Je savais pas que les princesses se cherchaient de l'ouvrage. Le chef te renvoie.\n\nGame Over\n"
page_14 = "\n\nLe chef te regardes avec dégoût. «Tu m'écoeures, remplis de jugement. On est en 2026, ce tattoo de larme représente sa sensibilité. Sors de ma cuisine.» \n\nGame Over\n"
...
page_17 = "\n\n«Est-ce que tu me donnes le même ordre que je viens juste de te donner? Fuck off man.» Il va voir le chef et lui apprend que tu ne sais rien. Il te renvoi.\n\nGame Over\n"
page_18 = "\n\nLe cuisinier te regarde. «Non.»"
...
page_21 = "\n\nPar miracle tu es accidentellement tombé sur le bon item, fiou. Le chef enchaîne. «Parfait!, maintenant prend une langue de chat, on en a pas beaucoup, t'en auras besoin tantôt.» "
...
page_24 = "\n\nTu claquais des doigts tellement fort, le chef t'as entendu et t'as vu faire. Il se rend compte que tu fais n'importe quoi. Tu perds ton emploi.\n\nGame Over\n"
...
page_27 = "\n\nIl s'approche et te pousse. Tu tombes contre le four et te brûle la main. Tu cries, tu as mal, personne ne t'aides. Tu quittes sans avertir. Le chef te texte plus tard pour te dire qu'il n'aime pas les fuyards. Tu es renvoyé.\n\nGame Over\n"
...
page_39 = "\n\nPersonne ne rit. Cette blague est misogyne, irrespectueuse et de trop. Tu es étrange, lourd et inconfortable à côtoyer. On te demande de partir.\n\nGame Over\n"
page_40 = "\n\nÉtrangement personne ne rentre dans ce frigo de tout le reste de ton quart de travail et personne ne remarque ton absence. Tu sors à la fin de ton shift. Félicitations.\n\nVictoire\n"
page_41 = "\n\nCome on, la cigarette c'est vilain. Tu ne perds pas ton emploi, mais tu perds au jeu de la vie.\n\nGame Over\n"
page_42 = "\n\nToute la cuisine fume, tu deviens automatiquement la honte du restaurant. Plus personne ne te parle et t'aide, le chef se rend vite compte que tu ne sais pas quoi faire. Il te demande de quitter.\n\nGame Over\n"
...
page_44 = "\n\nIl te donne 5$ et te laisse tranquille. Le chef vient te voir et t'annonce que la préparation est maintenant terminée. Félicitation, tu as terminé la premiere partie de ton premier shift coupé.\n\nVictoire\n"
...
page_46 = "\n\nLe chef n'a pas l'air d'apprécier. Il soupir fort et te dis de laisser ton tablier à l'entrée.\n\nGame Over\n"
