...
"""
# Pour intéragir avec le système d'exploitation Windows dans la fonction à la ligne 108.
import subprocess
...
# Options/choix disponibles pour chaque page.
...
blanchir_eau_bouillante = "Tu décides d'aller remplir une chaudière d'eau bouillante salée et une chaudière d'eau glacée pour les patates."
blanchir_signe_cuisinier = "Tu restes immobile, paniqué. Tu vois un cuisinier au loin qui te fait signe d'approcher. Tu te rends vers lui."
blanchir_peinture = "Tu fouilles partout à la recherche de peinture blanche."
chaudiere_remplie = "Tu vois deux chaudières remplies d'eau. Tu décides de sauver du temps pour mieux paraître. Tu pars avec."
...
tattoo_prejuge = "Tu paniques encore plus. Tu quittes la station et tu vas aviser ton chef que tu ne te sens pas en sécurité."
...
confrontation_docile = "Tu lèves les mains dans les airs et réponds nerveux:«Woah! Pour vrai je cherche pas la marde, promis!»"
confrontation_baveux = "Tu ne te laisses pas parler demême, tu réponds avec un ton hautain: «En ce-moment? Ton attitude.»"
reponse_non = "Tu lui réponds: «Honnêtement, Non.»"
reponse_oui = "Tu lui dis en hésitant: «Euhmm Ok..Oui»"
faux_rire_mechant = "Tu fais semblant de rire. Tu lui réponds: «Tu pourrais aller chez ta mère et aller le prendre directement de la vache haha»"
faux_rire_triste = "Tu fais semblant de rire et tu vas t'enfermer dans une des chambres froide. Cette blague t'as atteint."
...
# Variable à insérer dans la fonction choisir_options s'il n'y a que deux choix possibles.
absence_choix = " "

# Fonction pour choisir/progresser dans l'histoire
...
# Début du jeu
# Nomenclature: decision_(numéro de page) 
subprocess.run("cls", shell=True)
