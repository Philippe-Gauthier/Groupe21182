...
page_12 = "Le chef passe près de toi et voit que tu ne fais rien. Il te demande avec un ton fâché d'aller chercher des culs de poule pour continuer la préparation."
page_13 = "Tu viens de te tirer dans le pied. Une pause? En cuisine? Je savais pas que les princesses se cherchaient de l'ouvrage. Le chef te renvoie.\n\nGame Over\n"
...
page_21 = "Par miracle tu es accidentellement tombé sur le bon item, fiou. Le chef enchaîne. «Parfait!, maintenant prend une langue de chat, on en a pas beaucoup, t'en auras besoin tantôt.» "
...
page_46 = "Le chef n'a pas l'air d'apprécier. Il soupir fort et te dis de laisser ton tablier à l'entrée.\n\nGame Over\n"
